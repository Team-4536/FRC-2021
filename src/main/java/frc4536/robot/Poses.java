...
public class Poses {
    public static final Pose2d
            ...
            BOUNCE_WAYPOINT_TWO = new Pose2d(Units.feetToMeters(9.5),Units.feetToMeters(12.5),Rotation2d.fromDegrees(-270)),
            BOUNCE_WAYPOINT_THREE = new Pose2d(Units.feetToMeters(11.5),Units.feetToMeters(6.5),Rotation2d.fromDegrees(45)),
            BOUNCE_WAYPOINT_THREEHALF = new Pose2d(Units.feetToMeters(14.0),Units.feetToMeters(1.5),Rotation2d.fromDegrees(45)),
            BOUNCE_WAYPOINT_THREEEE= new Pose2d(Units.feetToMeters(16.0),Units.feetToMeters(1.5),Rotation2d.fromDegrees(0)),
            BOUNCE_WAYPOINT_FOUR = new Pose2d(Units.feetToMeters(17.5),Units.feetToMeters(12.5),Rotation2d.fromDegrees(-270)),
