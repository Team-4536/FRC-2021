...
public class Honeycomb implements RobotFrame {
    ...
    SpeedController m_rightIntakeArmPositionMotor = new WPI_VictorSPX(3); //TODO: Verify Right Intake Arm Position Motor Type
    ...
    SpeedController m_leftIntakeArmPositionMotor = new WPI_VictorSPX(1); //TODO: Verify Left Intake Arm Position Motor Type
